...
/**
 * For in-game sound effects. Most, if not all, sources should be in mono for placement in
 * order to work correctly for position parameters. If you don't care about
 * position or any of those things, go ahead with stereo.
 * 
...
//	}
	...
	/**
	 * Sets the resourcePath for the Source
	 * 
	 * @param string
	 */
	...
	public boolean equals(Object obj)
	{
		if (obj instanceof SoundSource)
		{
			...
			if ((mySource.getSourceID() == this.sourceID) && (mySource.resourcePath.equals(this.resourcePath) && (mySource.getNameID().equals(this.soundName))))
			{
				return true;
			}
		}
