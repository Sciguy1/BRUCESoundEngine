...
public class bruceWindow {

	// The window handle
	private long window;
	boolean[] keysArePressed = new boolean[512];
	...
	{
	    return (GLFW.glfwGetKey(window, key) == GLFW_PRESS);
	}
	...
	private void loop() {
		...
		soundManager.playClip("Megolovania");
		// Set the clear color
		...
		while ( !glfwWindowShouldClose(window) ) {
			...
			if(isKeyPressed(window, GLFW.GLFW_KEY_B)) {
				soundManager.swapPlaying("Forbidden_Friendship");
			}
			glfwPollEvents();
