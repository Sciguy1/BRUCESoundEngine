 ...
 *          
 *          OR
 *          setSources(<resourcePaths>, <allSources>) will do all three
 * 
 *         Note: If you attempt to rewind, play, stop, etc. and get a
 *         NullPointerException, it is more than likely that the name you have
 *         given to a track/method either does not exist or has been named incorrectly
 *
 */
public class SoundManager
{
	...
	/**
	 * Given the SoundSourceLoader is used, this can load resource paths and
	 * sound sources in one go, without the need for separate method calls.
	 * @param resourcePaths
	 * @param allSources
	 */
	...
	/**
	 * Helps set up the association with the buffers and sound sources
	 * Extremely important overall, but things keep getting switched around?
	 */
	public void place()
	{
		...
		for (int i = 0; i < tempSources.size(); i++)
		{
			...
			// Even though, technically, you should use the allBuffers here, but this works better
			// for playability.
	...
	/**
	 * Will clear the buffers and destroy ALC at the end.
	 * Note: Should *always* be called either on close of the game or in a similar vain.
	 */
	public void cleanUp()
	{
	...
	/**
	 * Will find the currently playing track, stop it, rewind it, and play the other track.
	 * @param otherTrack
	 */
	 ...
	 * the distance attenuation or similar factors.
	 * 
	 * @param buffer
	 */
